...
source("code/dgm6.R")
source("code/set_variance_prior.R")
source("code/init_setup_seso_uhpchp.R")
source("code/init_setup_memo.R")
source("code/label_flip.R")
Rcpp::sourceCpp("code/gibbs_seso_uhpchp.cpp", cacheDir ="/gpfs/data/linchen-lab/Bowei/")
Rcpp::sourceCpp("code/gibbs_joint_rcpp_nopr_pp_bound.cpp", cacheDir ="/gpfs/data/linchen-lab/Bowei/")
